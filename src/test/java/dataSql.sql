...
insert into users(name, phone, email, status) values("Tony", "13987878785", "Jim@test.com", 0);
insert into users(name, phone, email, status) values("Paul", "13987878784", "Jim@test.com", 0);
insert into users(name, phone, email, status) values("Ama", "13987878783", "Jim@test.com", 0)